...
@Injectable()
export class RespuestaSigedService {
  logger = new Logger();
  ...
  // TODO: ACEPTADO
  respuestaHttp200(data: any = null, ruta = '', message = '') {
    if (!message)
  ...
  // TODO: UPDATE OK
  respuestaHttp202(data: any = null, ruta = '', message = '') {
    if (!message)
      this.respuesta.message = [
  ...
  // TODO: DELETE OK
  respuestaHttp203(data: any = null, ruta = '', message = '') {
    if (!message)
      this.respuesta.message = [
  ...
  respuestaHttp400(data: any = null, ruta = '', message = '') {
  ...
  respuestaHttp401(data: any = null, ruta = '', message = '') {
  ...
  // TODO: NO AUTHORIZADO
  respuestaHttp403(data: any = null, ruta = '', message = '') {
    if (!message)
      this.respuesta.message = [
  ...
  respuestaHttp404(data: any = null, ruta = '', message = '') {
  ...
  respuestaHttp409(data: any = null, ruta = '', message = '') {
  ...
  respuestaHttp500(data: any = null, ruta = '', message = '') {
